...
public class AddTestData {
	...
	public Data defineTestData() {
	
	// Define two new entries
	Application testApp1 = new Application("1", "Maya", "2019", "c:/maya", "", "This is our main app");
	Owner testOwner1 = new Owner("0001", "Peter", "WzB", "office", "PM", "This is our project owner");
	Renderengine testEngine1 = new Renderengine("01", "Arnold", "c:/arnold", "-b -D -aa", "3.2.0", "This is our render engine");
	...
	Application testApp2 = new Application("1", "Houdini", "18.5", "c:/houdini", "", "This is Houdini");
	...
	myList.add(testProject1);
	myList.add(testProject2);
	
	Data myData = new Data();
	myData.setAllProjects(myList);
